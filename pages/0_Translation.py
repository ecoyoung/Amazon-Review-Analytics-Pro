...
def main():
    ...
    if translation_engine == "腾讯翻译API":
        ...
        try:
            ...
            sdk_installed = False
            st.error("❌ 腾讯云SDK未安装，请先安装依赖包")
            st.markdown("""
            <div style="background: #f8d7da; border: 1px solid #f5c6cb; border-radius: 8px; padding: 1rem; margin: 1rem 0;">
                <h5 style="color: #721c24; margin-bottom: 0.5rem;">🔧 安装腾讯云SDK</h5>
                <p style="color: #721c24; font-size: 0.9rem; margin: 0.5rem 0;">
                    请在终端中运行以下命令安装腾讯云SDK：
                </p>
                <div style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 4px; padding: 0.5rem; margin: 0.5rem 0; font-family: monospace; font-size: 0.8rem;">
